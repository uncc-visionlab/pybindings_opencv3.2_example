...
#include "pybv_generated_include.h"
...
#if PY_MAJOR_VERSION >= 3
#define MKTYPE2(NAME) pybv_##NAME##_specials(); if (!to_ok(&pybv_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) pybv_##NAME##_specials(); if (!to_ok(&pybv_##NAME##_Type)) return
#endif
...
#include "pybv_generated_types.h"
#include "pybv_generated_funcs.h"
...
#include "pybv_generated_ns_reg.h"
...
#if PY_MAJOR_VERSION >= 3
extern "C" CV_EXPORTS PyObject* PyInit_bv();
static struct PyModuleDef bv_moduledef =
{
...
PyObject* PyInit_bv()
#else
extern "C" CV_EXPORTS void initbv();
...
#include "pybv_generated_type_reg.h"

#if PY_MAJOR_VERSION >= 3
  PyObject* m = PyModule_Create(&bv_moduledef);
#else
